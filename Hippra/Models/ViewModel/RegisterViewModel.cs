...
{
    public class RegisterAccountTypeViewModel
    {
        [Required]
        [EmailAddress]
        [Display(Name = "Email")]
        ...
        [Required]
        [Range(1,3, ErrorMessage = "Please select account type.")]
    ...
    public class RegisterViewModel
    {
        ...
        public RegisterAccountTypeViewModel RegisterAccountType { get; set; }
